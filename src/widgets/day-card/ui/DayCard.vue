    ...
    <tou-card-content class="pt-0 flex-1 flex flex-col overflow-visible">
      ...
      >
        ...
        >
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
            ...
            >
              ...
              <button
                ...
                :class="selectedMenu?.[category.key] ? 'bg-green-50/60' : ''"
          ...
          <div class="pt-4 sm:pt-5 border-t border-gray-200/60">
            <button
              type="button"
...
import { CookAssignmentModal } from '@/features/menu/assign-cook'
import { DishSelectionModal } from '@/features/menu/select-dish'
...
defineEmits<{
  (e: 'update-menu', category: MenuCategory, value: string): void
  (
    e: 'update-cook',
    field: 'cook_day' | 'cook_brunch' | 'cook_dinner' | 'cook_dessert',
    value: '' | 'me' | 'partner',
  ): void
}>()
