...
const variantClassesMap = {
  default: 'bg-gradient-to-r from-purple-600 to-pink-600 text-white shadow-lg hover:shadow-xl hover:from-purple-700 hover:to-pink-700 glow',
  destructive: 'bg-gradient-to-r from-red-500 to-rose-600 text-white shadow-lg hover:shadow-xl',
  outline: 'glass border-2 border-white/30 text-gray-800 hover:bg-white/20 hover:border-white/50',
